...
public class adTrainProducer {
    public static void main(String[] args) {
        KafkaProducer<Integer, String> producer;

        Properties props = new Properties();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaProperties.KAFKA_SERVER_URL + ":" + KafkaProperties.KAFKA_SERVER_PORT);
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "DemoTrainProducer");
        ...
        for (CSVRecord record: csvParser) {
            ...
            int uid = Integer.parseInt(record.get("uid"));
            int label = Integer.parseInt(record.get("label"));
            ...
            ProducerRecord producerRecord = new ProducerRecord<>(KafkaProperties.TRAIN_TOPIC, message);
